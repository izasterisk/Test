# UNIT TEST - ApproveVendorProfile

| Function Code | VP-002 | Function Name | | ApproveAsync |
|---------------|--------|---------------|---|--------------|
| **Created By** | | **Executed By** | | |
| **Lines of code** | 35 | **Lack of test cases** | | |
| **Test requirement** | Verify vendor profile approval process | | | |
