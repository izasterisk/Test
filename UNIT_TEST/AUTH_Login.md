...
| Function Code | Test Login | Function Name | | Login |
|---------------|------------|---------------|---|-------|
| **Created By** | Tester Name | **Executed By** | | Tester Name |
| **Lines of code** | 40 | **Lack of test cases** | | |
| **Test requirement** | Login | | | |
...
| **Result** | Type(N : Normal, A : Abnormal, B : Boundary) | | N | A | B | A | A | A | A | A |
| | Passed/Failed | | | | | | | | | |
| | Executed Date | | | | | | | | | |
| | Defect ID | | | | | | | | | |
